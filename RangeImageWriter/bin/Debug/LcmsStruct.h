...
struct sLcmsSensorBoardInfo{
    ...
    char asSensorSerialNumber[32];
    char asSensorCalirationNumber[32];
...
struct sLcmsSensorParam{
    ...
    static const int ciSensorParamVersion=3;  // Version of this structure
    ...
    char           acIntCompressionParam[32]; // Intensity data compression parameter
...
struct sLcmsGeometricParam{
    ...
    static const int ciGeometricParamVersion=1; // Version of this structure
...
struct sLcmsImuCalibParam{
    ...
    static const int ciImuCalibParamVersion=1; // Version of this structure
...
struct sLcmsInsOxtsCalibParam{
    static const int ciInsOxtsCalibParamVersion=2; // Version of this structure
...
//    char          acSoftwareIdKey[128];       // Acquisition Software identification key
